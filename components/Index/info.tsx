...
const Mains = ({ club }: any) => {
  const lists = [
    ...
    [
      "UNIFOX",
      "Unifox는 선린인터넷고등학교 정보보호과 전공동아리로 프로그램 개발에 기본이 되는 알고리즘, 보안 프로그래밍 등 다양한 분야를 공부하는 학생들이 모여 구성된 프로그래밍 동아리입니다. 저희는 부원들의 관심 분야에 맞추어 다양한 분야의 수업을 진행하고 선후배간 멘토링을 통해 자신이 원하는 분야를 자유롭게 공부합니다. 또한 팀, 개인 프로젝트를 진행하며 자신이 공부하고 싶은 분야의 실력을 향상시킵니다.",
      "http://unifox.kr/",
      "http://show.unifox.kr",
      "rgb(246, 179, 61, 0.5)",
      "rgb(246, 179, 61, 0.7)",
